...
var vegetables = ["jalepeno", "daikon", "radish", "onion", "cilantro"];
...
fruits = ["sour cherries", "watermelon", "bluberries", "dragonfruit", "pomegranate"];
// console.log(fruits);
...
groceryStore.loction = "Denver, Colorado";
// console.log(groceryStore);